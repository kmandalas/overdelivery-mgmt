...
- [ ] Enable the [aodm-common module](https://github.com/kmandalas/overdelivery-mgmt/tree/master/common) in order to avoid code duplication among the various microservices regarding shared DTOs
